...
class RiskFactor(BaseModel):
    """A detected risk factor with points."""
    factor: str
    points: int
    evidence: str = ""
...
class RiskAssessment(BaseModel):
    ...
    total_factors_detected: int = 0
    disclaimer: str = (
        "This risk assessment is generated by AI based on conversation content only. "
        "It does not constitute a medical diagnosis. Always consult with a qualified "
        "healthcare provider."
    )
